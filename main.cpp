...
int main()
{
    ...
    if (!(background.loadFromFile("R.png")))//Фон берём из файла
    {
    ...
    if (!(nyn.openFromFile("Nyan_Cat_-_Nyan_Cat_Theme__musmore.com_.wav")))//Забираем музыку из файла
    {
        nyn.openFromFile("../Nyan_Cat_-_Nyan_Cat_Theme__musmore.com_.wav");
    }
