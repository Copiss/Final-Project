...
using namespace Game; //подключение именного пространства
    ...
    int main()
    {
        ...
        ball.shape.setRadius(20);// Установка радиуса круга
        ...
        background.loadFromFile("R.png");//Фон берём из файла
        sf::Sprite pp(background);//Создание спрайта заднего фона

        sf::Music nyn;//Объявляем музыку
        nyn.openFromFile("Nyan_Cat_-_Nyan_Cat_Theme__musmore.com_.wav");//Забираем музыку из файла
